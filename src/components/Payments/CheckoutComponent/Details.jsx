...
let PsicologyTax = psychologistCommission * 0.05;
let total = (psychologistCommission + stripeTax + PsicologyTax)
      ...
      const line_items = [
         {
            ...
            price_data: {
               ...
               product_data: {
                  ...
                  description: 'Psicology S.A.',
                  images: [`${baseURL}/${psyDetails.profileImage}`]
