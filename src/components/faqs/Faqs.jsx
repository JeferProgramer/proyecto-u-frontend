          ...
          <Container maxW={'8xl'} mt={10} marginBottom='10%'>
            <Stack spacing={10}>
              ...
              <HStack align={'top'}>
                ...
                <VStack align={'start'}>
                  <Text fontWeight={600}>¿Como son seleccionados los psicólogos en EasyPsycho?</Text>
                  <Text color={'gray.600'}>Todos los psicólogos en EasyPsycho son profesionales con un título obtenido en una institución de educación acreditada. Además, EasyPsycho revisa los antecedentes de cada psicólogo para evaluar su aceptación en la plataforma. A cada psicólogo registrado se le pide un certificado que acredite la obtención de un título en una institución certificada y un certificado de antecedentes. Además la información sobre la formación de cada psicólogo te es entragada en la sección del perfil del psicólogo.</Text>
                </VStack>
              </HStack>
              <HStack align={'top'}>
                <Box color={'green.400'} px={2}>
