...
import { AdminEditUserPsichologist, AdminGetUserPsychologistDetail, AdminDeleteUserPsichologist, AdminGetAllPsychologist } from '../../../../redux/actions';
        ...
        Swal.fire({
            ...
            if (result.isDenied) {
                if (e.target.value === 'Pendiente') {
                    ...
                    .then(res => navigate(`/adminpanel/psychologists/${psychologistId}`))
                    .then(res => dispatch(AdminGetUserPsychologistDetail(IdUserPsychologist)))
                } else {
                            ...
                            ? (
                                <Stack w='100%' direction='column' justify='center' align='center' position={'relative'} top={-5}>
                                    ...
                                    <Stack direction='column'>
                                        <Avatar src={`${baseURL}/${userPsichologistDetail.profileImage}`} size='xl' />
